...
const Bag: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed right-0 top-0 z-20 flex h-[100dvh] w-screen flex-col border border-black bg-stone-50 md:right-3 md:top-3 md:h-[calc(100%-1.5rem)] md:w-96 md:rounded-md"
    >
      {itemsInBag ? (
        <>
